 ...
 * generated in the TTTWebApplication package. 
...
public class ObjectFactory {
    ...
    private final static QName _Test_QNAME = new QName("http://server.james.ttt/", "test");
    ...
    private final static QName _TestResponse_QNAME = new QName("http://server.james.ttt/", "testResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: TTTWebApplication
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.james.ttt/", name = "test")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.james.ttt/", name = "testResponse")
