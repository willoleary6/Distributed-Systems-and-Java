...
<script>
    const mainMenuNameSpace = {
        ...
        currentListOfMyGames: "",
        currentListOfMyOpenGames: "",
        getAllMyOpenGames: () => checkAllMyOpenGames(),
        getAllOpenGames : () => checkAllOpenGames(),
        getAllMyGames: () => checkAllMyGames(),
        worker: undefined,
    }
    ...
    const checkAllMyOpenGames = () => {
        $.ajax({
            ...
            cache:false,
            success: (results) => {
                if(results != mainMenuNameSpace.currentListOfMyOpenGames){
                    mainMenuNameSpace.currentListOfMyOpenGames = results;
    ...
    const checkAllMyGames = () => {
        $.ajax({
            ...
            cache:false,
            success: (results) => {
                if(results != mainMenuNameSpace.currentListOfMyGames){
                    mainMenuNameSpace.currentListOfMyGames = results;
